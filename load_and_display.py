...
if __name__ == "__main__":
    ...
    argparse = argparse.ArgumentParser(description="Load and display a point cloud with its bounding boxes")
    ...
    logger.info("Displaying axis_aligned_bounding_box in red and oriented bounding box in green ...")
