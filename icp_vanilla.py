...
if __name__ == "__main__":
    ...
    argparse.add_argument("--threshold", type=float, help="threshold for ICP", default=0.02)
    argparse.add_argument("--max_iter_icp", type=int, help="max number of iterations for ICP", default=2000)
    ...
    reg_p2p = o3d.pipelines.registration.registration_icp(
        ...
        o3d.pipelines.registration.ICPConvergenceCriteria(max_iteration=args.max_iter_icp))
    logger.info(f"{reg_p2p}")
    logger.info("Transformation is:")
    logger.info(f"{reg_p2p.transformation}")
    draw_registration_result(source, target, reg_p2p.transformation, "ICP point-to-point")
    ...
    draw_registration_result(source, target, reg_p2l.transformation, "ICP point-to-plane")